<div class="col-12">
    <div class="card directory-card">
        <div class="p-3 bg-transparent card-header d-flex justify-content-between">
            ...
            <div>
                <a class="btn btn-primary" href="{{ route('admin.bids.create') }}">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="datatable-buttons"
                                    class="list-container table-sm table table-striped table-bordered dt-responsive nowrap"
                                    ...
                                    <tbody>
                                        @foreach ($bids as $bid)
                                            <tr id="row_{{ $bid->id }}">
                                                <td><a
                                                        href="{{ route('admin.projects.show', ['project' => $bid->apartment->floor->block->project->id]) }}">{{ $bid->apartment->floor->block->project->name }}</a>
                                                </td>
                                                ...
                                                <td>
                                                    @switch($bid->level_of_interest)
                                                        ...
                                                        @case(2)
                                                            <i style="color:#ffe900" class="fas fa-star"></i><i
                                                                style="color:#ffe900" class="fas fa-star"></i>
                                                        @break

                                                        @case(3)
                                                            <i style="color:#ffe900" class="fas fa-star"></i><i
                                                                style="color:#ffe900" class="fas fa-star"></i><i
                                                                style="color:#ffe900" class="fas fa-star"></i>
                                                        @break
