...
@section('content')
    ...
    @include('includes.page-title-box', [
        ...
        'pageDescription' => 'Sistemde sözleşme için düzeltmeye yapılır',
    ])
    <!-- end page title -->
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" class="needs-validation" novalidate
                        action="{{ route('admin.contracts.update', $contract->id) }}" autocomplete="off"
                        ...
                        <section>
                            <div class="row">
                                <div class="col-sm-8">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="title" value="{{ $contract->title }}"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select type="text" class="form-control" id="project_id"
                                            ...
                                            @foreach ($projects as $project)
                                                <option @if ($project->id == $contract->project_id) selected @endif
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea type="text" class="form-control" id="body" placeholder="Başlık" name="body"
                                    required>{{ $contract->body ?? old('body') }}</textarea>
                                <div class="invalid-feedback">
                                    Lütfen geçerli bir isim giriniz.
                                </div>
                            </div>
